...
internal sealed class Settings
{
    ...
    private const string _defaultTextColor = "#FFE4E4E4";
    ...
    public string TextColor { get; set; } = _defaultTextColor;
    ...
    [JsonIgnore]
    public D3DCOLORVALUE Text => D3DCOLORVALUE.TryParseFromName(TextColor, out var color) ? color : D3DCOLORVALUE.TryParseFromName(_defaultTextColor, out var fallback) ? fallback : Theme.Text;
}
